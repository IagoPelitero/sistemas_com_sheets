...
function settingDescription_(key) {
  const map = {
    ...
    'comissao.cartaoDigital.valorArgumentacao': 'Cartão DIGITAL: R$ por retenção via Argumentação (direto, sem pontos)',
    'comissao.cartaoDigital.valorIncentivo': 'Cartão DIGITAL: R$ por retenção via Incentivo (direto, sem pontos)',
