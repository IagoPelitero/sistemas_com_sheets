...
function settingDescription_(key) {
  const map = {
    ...
    'comissao.digital.contaPorRetencao': 'DIGITAL: R$ por retenção de Conta (0 = sem comissão unitária)',
    'comissao.digital.cashbackPorConversao': 'DIGITAL: R$ por conversão de Cashback (0 = sem comissão unitária)',
