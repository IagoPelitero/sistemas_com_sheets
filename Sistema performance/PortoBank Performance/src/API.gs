    ...
    switch (action) {
      ...
      case 'session':
        data = {
          ...
          entryDeleteLimit: ENTRY_DELETE_LIMIT,
          themes: THEMES,
      ...
      case 'ranking': data = rankingBuild_(me, payload.mes, payload.periodo); break;
      ...
      case 'goals.get': data = goalsGetFor_(me, payload); break;
